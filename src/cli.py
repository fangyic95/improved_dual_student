...
def create_parser():
    ...
    parser.add_argument('--resume-r', default='', type=str, metavar='PATH',
                        help='path of the resume checkpoint (default: '')')
    ...
    parser.add_argument('--res-loss-switch', default=True, type=str2bool,
                        help='use res-loss', metavar='BOOL')
    parser.add_argument('--consistency-loss-switch', default=True, type=str2bool,
                        help='use consistency-loss', metavar='BOOL')
    parser.add_argument('--stabilization-loss-switch', default=True, type=str2bool,
                        help='use stabilization-loss', metavar='BOOL')

    parser.add_argument('--cnnfeature2consis', default=False, type=str2bool,
                        help='use cnn feature for consistency loss', metavar='BOOL')
    parser.add_argument('--cnnfeature2stable', default=False, type=str2bool,
                        help='use cnn feature for stabilization loss', metavar='BOOL')
